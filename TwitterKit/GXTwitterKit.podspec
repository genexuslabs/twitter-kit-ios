Pod::Spec.new do |s|
  ...
  s.resources = ["TwitterKit.xcframework/ios-arm64/TwitterKit.framework/TwitterKitResources.bundle", "TwitterKit.xcframework/ios-arm64/TwitterKit.framework/TwitterShareExtensionUIResources.bundle"]
  s.frameworks = "CoreText", "QuartzCore", "CoreData", "CoreGraphics", "Foundation", "Security", "UIKit", "CoreMedia", "AVFoundation", "SafariServices"
  s.dependency "GXTwitterCore", ">= 3.3.2"
end
